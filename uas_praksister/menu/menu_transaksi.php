    ...
    <div class="d-flex bg-info text-white" id="wrapper">
        ...
        <div id="page-content-wrapper" style="background-color: #9BA1A8;">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="menu_tambah_transaksi.php" role="button">Tambah</a>
                    ...
                    <tbody>
                        ...
                        foreach ($data_array as $r) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <!-- <form action="menu_edit_transaksi.php?id_transaksi=<?php echo $r->id_transaksi ?>"
                                        method="post">
                                    ...
                                    <p></p>
                                    <form
                                        action="../client/proses_transaksi.php?aksi=hapus-transaksi&id_transaksi=<?php echo $r->id_transaksi ?>"
                                        method="post">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus-transaksi" value="Hapus"
