                        ...
                        foreach ($data_array as $r) {
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p></p>
                                    <form
                                        action="../client/proses_pemasok.php?aksi=hapus-pemasok&id_pemasok=<?php echo $r->id_pemasok ?>"
                                        method="post">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus-pemasok" value="Hapus"
