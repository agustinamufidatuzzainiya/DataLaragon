    ...
    <div class="d-flex bg-info text-white" id="wrapper">
        ...
        <div id="page-content-wrapper" style="background-color: #9BA1A8;">
            ...
            <div class="container-sm">
                ...
                <a class="btn btn-primary mb-2 btn-sm" href="menu_tambah_sepeda.php" role="button">Tambah</a>
                <table class="table table-light table-striped rounded table-hover">
                    <thead>
                        <tr>
                            <th scope="col" width="50">No</th>
                            <th scope="col">ID Sepeda</th>
                    ...
                    <tbody>
                        ...
                        foreach ($data_array as $r) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <img width="100" src="<?= $r->gambar_sepeda; ?>">
                                </td>
                                <td>
                                    <?= $r->ukuran; ?>
                                </td>
                                ...
                                <td>
                                    <form action="menu_edit_sepeda.php?id_sepeda=<?php echo $r->id_sepeda ?>" method="post">
                                        <input class="btn btn-success btn-sm" type="submit" value="Edit">
                                    </form>
                                    <p></p>
                                    <form
                                        action="../client/proses_sepeda.php?aksi=hapus-sepeda&id_sepeda=<?php echo $r->id_sepeda ?>"
                                        method="post">
                                        <input class="btn btn-danger btn-sm" type="submit" name="hapus-sepeda" value="Hapus"
                                            onClick="return confirm('Apakah anda ingin menghapus data sepeda?')">
                                    </form>
                                </td>
                            </tr>
                            <?php
