            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <body>
                        ...
                        $response =  $client->request('GET', '/api/Idbeautycare', [
                            'json' => [
                                'id' => $id,
                            ]
                        ]);
                        ...
                        <h5>Edit Produk Beauty care</h5>

                        <form action="edit_beauty.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
                            <div class="body">
                            ...
                            <div class="modal-footer d-flex">
                                <a class="btn btn-danger btn-lg" href="beautycare.php">Cancel</a>
