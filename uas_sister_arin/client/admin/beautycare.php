    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          ...
          <button type="button" class="btn btn-primary btn-lg mb-4" data-bs-toggle="modal" data-bs-target="#beautytambah">
            Tambah
          </button>
          ...
          <div class="card mb-4">
            ...
            <div class="card-body">
              ...
              <table id="datatablesSimple" class="table">
                ...
                <?php
                $no = 1;
                foreach ((array)$dataBeautyCare as $data) { ?>
                  <tr>
                    <td><?php echo $no++ ?></td>
                    ...
                    <td class="text-center" style="min-width: 120px;">
                      <a href="form_edit_beauty.php?id=<?php echo $data->id; ?>"> <button type="button" class="btn btn-sm btn-success">Edit</button></a>
                      <a href="delete_beauty.php?id=<?php echo $data->id; ?>"> <button type="button" class="btn btn-sm btn-danger" onclick="showSuccessMessage()">Hapus</button></a>
                ...
                <div class="modal fade" id="beautytambah" role="dialog">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Tambah Produk Bodycare</h5>
                      </div>
                      <form action="add_beauty.php" method="POST" enctype="multipart/form-data">
                        <div class="modal-body">
                          <div class="form-group">
                            <label class="control-label" for="id_field">Id Produk</label>
                            <input type="text" class="form-control" value="<?php echo $nextIdBeautyCare; ?>" id="id_field" name="id" readonly>
                          </div>
                          <div class="form-group">
